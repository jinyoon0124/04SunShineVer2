...
/**
 * Created by Jin Yoon on 8/3/2016.
 */
public class TodayWidgetIntentService extends IntentService{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for(int appWidgetId: appWidgetIds){
            ...
            views.setTextViewText(R.id.widget_temp_high, formattedMaxTemperature);
            views.setTextViewText(R.id.widget_temp_low, formattedMinTemperature);
