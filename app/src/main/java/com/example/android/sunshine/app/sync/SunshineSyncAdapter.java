    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if(forecastJson.has(OWM_MESSAGE_CODE)){
                ...
                switch(errorCode){
                    case HttpURLConnection.HTTP_OK: //code = 200
                        break;
                    case HttpURLConnection.HTTP_NOT_FOUND: //code = 404
                        setLocationStatus(getContext(), LOCATION_STATUS_SERVER_INVALID);
                        break;
                    default:
                        setLocationStatus(getContext(), LOCATION_STATUS_SERVER_DOWN);
...
//                            Utility.getArtResourceForWeatherCondition(weatherId));
    ...
    private static void setLocationStatus(Context c, @LocationStatus int locationStatus){
        ...
        e.putInt(c.getString(R.string.pref_location_status_key), locationStatus);
        e.commit();
    }
}